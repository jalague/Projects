...
//		SoundUtil.play(one_four);
		...
		MusicLinkedList be_cool = SoundUtil.readWAVFile("be_cool.wav");
		System.out.println("Be cool");
	//	be_cool.changeSpeed((float).);
		//be_cool.addEcho((float).5, (float).75);
		SoundUtil.play(be_cool);
		//be_cool.combine(m, false);
